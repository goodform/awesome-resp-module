...
| Repo                                                                        | Description                                                                               | Tags     | Status                                          |
| --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | -------- | ----------------------------------------------- |
| [RediSearch/RediSearch](https://github.com/RediSearch/RediSearch)           | Secondary index, full-text search, vector search, and aggregation query engine.           | `search` | 2026-08-12 · Redis Source Available License 2.0 |
